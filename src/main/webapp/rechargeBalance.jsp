...
<div>
    <form autocomplete="off" action="/workshop_war_exploded/manager/balance" method="post" class="form-horizontal" role="form">
        <div class="form-group">
            <div class="col-sm-9" align="center">
                ...
                <div class="form-group">
                    <div class="col-sm-9">
                        <input type="text" placeholder="Sum of money" name="sum"
                               class="form-control" minlength="1" maxlength="30"/>
                    </div>
                </div>
