...
@WebServlet(name = "GetAllOrdersByPriceServlet", value = "/manager/orders/price")
public class GetAllOrdersByPriceServlet extends HttpServlet {
    private final OrderService orderService;

    public GetAllOrdersByPriceServlet() throws SQLException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            request.setAttribute("orders", orderService.getAllOrderByPrice());
