...
@WebServlet(name = "GetAllOrdersByDateServlet", value = "/manager/orders/date")
public class GetAllOrdersByDateServlet extends HttpServlet {
    private final OrderService orderService;

    public GetAllOrdersByDateServlet() throws SQLException {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            request.setAttribute("orders", orderService.getAllOrderByDate());
